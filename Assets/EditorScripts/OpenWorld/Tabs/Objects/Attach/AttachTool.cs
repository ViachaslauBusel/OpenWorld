    ...
    class AttachTool
    {
        ...
        private static void AttachObjectOnMap(GameObject[] gameObjects)
        {
            ...
            foreach (GameObject obj in gameObjects)
            {
                ...
                if (!AssetImporter.GetAtPath(pathToPrefab).assetBundleName.StartsWith(TabSetting.Map.Name.ToLower())) { Debug.LogError("Добавляемый объект не прикреплён к бандлу или находиться в неправильном бандле"); continue; }
